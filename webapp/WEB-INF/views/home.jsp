                ...
                <c:choose>
                    <c:when test="${loop.index==0}">
                        <div class="item active">
                            <img src="${urlPublic}/images/${banner.archivo}.jpg" alt="${banner.titulo}" title="${banner.titulo}" >
                        </div>
                    </c:when>
                    <c:otherwise>
                        <div class="item">
        ...
        <div class="row">
            ...
            <c:forEach items="${peliculas }" var="pelicula">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <p><a class="btn btn-sm btn-primary" href="${urlRoot}detail/${pelicula.id }/${fecha}" role="button">Consulta Horarios &raquo;</a></p>
                </div>
            </c:forEach>
